...
WebUI.setText(findTestObject('kompasLogin/halamanLogin/input_KG Media ID_email'), 
    'faizoktarivandi@gmail.com')

WebUI.click(findTestObject('kompasLogin/halamanLogin/input_Password_password'))

WebUI.setEncryptedText(findTestObject('kompasLogin/halamanLogin/input_Password_password'), 
    '2bZXWlVPxzLCSswz1LWJbQ==')
...
WebUI.setText(findTestObject('Object Repository/kompasLogin/halamanUtama/input_q'), 
    'amerika')

WebUI.sendKeys(findTestObject('Object Repository/kompasLogin/halamanUtama/input_q'), 
